...
adb pull /system/vendor/lib/mediadrm/libwvdrmengine.so ../../../vendor/$MANUFACTURER/$DEVICE/proprietary/libwvdrmengine.so
adb pull /system/vendor/lib/libfrsdk.so ../../../vendor/$MANUFACTURER/$DEVICE/proprietary/libfrsdk.so
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/__MANUFACTURER__/__DEVICE__/proprietary/libwvdrmengine.so:system/vendor/lib/mediadrm/libwvdrmengine.so \\
    vendor/__MANUFACTURER__/__DEVICE__/proprietary/libfrsdk.so:system/vendor/lib/libfrsdk.so \\
