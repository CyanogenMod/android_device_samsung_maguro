...
public class Utils {
    private static final String TAG = "MaguroParts_Utils";
    private static final String TAG_READ = "MaguroParts_Utils_Read";
    private static final String TAG_WRITE = "MaguroParts_Utils_Write";
